...
<body>
    ...
    <div class="w3-container" style="padding:128px 16px" id="team">
        ...
        <div class="w3-row-padding w3-grayscale-min" style="margin-top:64px">
            <div class="w3-col l2 m4 w3-margin-bottom">
                <div class="w3-card">
                    <img src="/static/linkdin photos (2).png" alt="John" style="width:100%">
            ...
            <div class="w3-col l2 m4 w3-margin-bottom">
                <div class="w3-card">
                    <img src="/static/linkdin photos (2).png" alt="James" style="width:100%">
                    <div class="w3-container">
                        <h3>James Ferry</h3>
            ...
            <div class="w3-col l2 m4 w3-margin-bottom">
                <div class="w3-card">
                    <img src="/static/linkdin photos (2).png" alt="Mike" style="width:100%">
                    <div class="w3-container">
            ...
            <div class="w3-col l2 m4 w3-margin-bottom">
                <div class="w3-card">
                    <img src="/static/linkdin photos (2).png" alt="Dan" style="width:100%">
                    <div class="w3-container">
                        <h3>Juan Ceballos</h3>
    ...
    <div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
        ...
        <div class = "w3-center"style="margin-top:48px">
            ...
            <img src="/static/Location.png" class="w3-image w3-greyscale" style="width:100%;margin-top:48px">
        </div>
    </div>
